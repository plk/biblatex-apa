...
Thanks to Jürgen Spitzmüller for the DGP localisation hints.
...
\begin{release}{7.0}{2016}
\item Added \cmd{urldatacomma}
\item Now following DGP guidelines for some formatting in Germanic locales.
\end{release}
