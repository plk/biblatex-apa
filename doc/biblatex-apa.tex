...
\minisec{9.18}
The package now correctly uses ampersand as the name separator for
\cmd{textcite} when inside a table.
...
to Razvan-Gabriel Geangu for the Romanian translation. Thanks to Bernard
Jacquemin for better French translation.
...
\begin{release}{9.20}{2025-08-27}
  \item Russian localisation fix
\end{release}

\begin{release}{9.19}{2025-08-03}
