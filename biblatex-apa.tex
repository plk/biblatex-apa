...
|\DeclareQuotePunctuation| option as mentioned in section \ref{req} above.
...
If using the «american» babel language, there is no need to do anything as 

\begin{ltxcode}
\DeclareLanguageMapping{american}{american-apa}
\end{ltxcode}

is the default. The APA manual does not mention nor sanction any non «American» English
...
\item Moved localisation strings into \sty{.lbx} files using |\DeclareLanguageMapping|
\end{release}
