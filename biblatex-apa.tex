...
You will need to be using \sty{csquotes} ($\geq$ 4.3), \sty{biblatex}
($\geq$ 1.4) and the \sty{biber} backend for \sty{biblatex} ($\geq$
0.9). If you want to take advantage of the \sty{biblatex}
...
set up |\DeclareQuotePunctuation| yourself as per section |4.7.5| of the
\sty{biblatex} manual.
...
parameterise the max authors setting.
...
\begin{release}{2.7}{2011-03-30}
\item Biber is now a requirement due to the APA list disambiguation functionality.
