...
2.4) and Biber ($\geq$ 1.4). If you want to take advantage of the
...
Johann Gründl for the Austrian localisation.
...
\begin{release}{5.9}{2013-03-20}
\item Compatibility with biblatex 2.6--«nodate» is now part of biblatex.
\end{release}
