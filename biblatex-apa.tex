...
\item There are some anomalies like \apa[17]{4.16} where two years are
  ...
  other fields like |ORIGDATE| as in \apa[40]{4.16}. There isn't even that
  option in \apa[17]{4.16} because |ORIGDATE| and |DATE| are the opposite
...
\begin{release}{0.7}{2009-11-20}
\item Updated for \sty{biblatex} 0.9
\item Updated for APA 6th edition
\end{release}
